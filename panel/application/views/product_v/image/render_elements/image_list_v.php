							...
							<?php foreach($item_image as $image){ ?>
								...
								<tr id="ord-<?php echo $image->id; ?>">
									...
									<td class="w100 text-center">
										<img width="60px" src="<?php echo base_url("uploads/{$viewFolder}/$image->img_url"); ?>" alt="<?php echo $image->img_url; ?>" class="img-responsive"
									</td>
									...
									<td class="w100">	
										<input 
										data-url="<?php echo base_url("product/isCoverSetter/$image->id/$image->advertisement_id"); ?>"
										class="isCover"
										type="checkbox" 
									...
									<td>
										<button
											data-url="<?php echo base_url("product/imageDelete/$image->id/$image->advertisement_id"); ?>"
											class="btn btn-sm btn-danger remove-btn btn-block">
