    ...
    public function save(){
        ...
        $this->form_validation->set_message(
            array(
                ...
                "matches" => "Şifreler aynı olmalıdır.",
                "min_lenght"=> "<b>{field}</b> alanı 6 karakterden az olamaz",
                "max_lenght"=> "<b>{field}</b> alanı 8 karakterden fazla olamaz"
            )
        );
